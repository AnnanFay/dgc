...
public class JXTransformer extends JPanel {
    ...
    private String d(Dimension dim){
    ...
    public void doLayout() {
        if (view != null) {
            ...
            //System.out.println("PrefSizeSet : " + isPreferredSizeSet());
            //System.out.println("view        : " + d(view.getSize()) + " -> " + d(view.getPreferredSize()));
            //System.out.println("transformer : " + d(this.getSize()) + " -> " + d(this.getPreferredSize()));

            Dimension thisSize = this.getSize();
            Dimension newDim = new Dimension((int)thisSize.getHeight(), (int)thisSize.getWidth());

            Insets insets = getInsets();
            newDim.width -= insets.left + insets.right;
            newDim.height -= insets.top + insets.bottom;
    ...
    public Dimension getPreferredSize() {
        ...
        Dimension size = getPreferredTransformedSize().getSize();
        Insets insets = getInsets();
    ...
    private Rectangle getPreferredTransformedSize() {
        if (view != null) {
